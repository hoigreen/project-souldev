      ...
      <Container>
        <div className="flex w-full flex-col justify-center gap-y-12 md:gap-y-16 lg:gap-y-20">
          <div className="w-full space-y-4 md:space-y-6 lg:space-y-8">
            <h1 className="text-center text-2xl font-bold leading-snug text-background xs:text-3xl md:text-4xl md:leading-snug lg:text-5xl lg:leading-snug xl:text-6xl xl:leading-snug">
              {t('M23')}
            </h1>
