...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'dark:bg-bg-neutral-700 mx-auto flex h-12 w-full items-center justify-center rounded-md bg-neutral-200 px-2 py-1 text-muted-foreground md:w-fit md:min-w-[30rem]',
      className,
    )}
    {...props}
  />
